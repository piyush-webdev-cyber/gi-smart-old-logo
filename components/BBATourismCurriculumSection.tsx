...
const BBATourismCurriculumSection = () => {
  ...
  const yearDescriptions: { [key: number]: string } = {
    1: 'Build a strong foundation in tourism and hospitality fundamentals, service excellence, and customer relations.',
    2: 'Master operational management, sustainability practices, and technology integration in hospitality.',
    3: 'Develop innovation skills, international business acumen, and entrepreneurship in tourism.',
    4: 'Lead strategic initiatives, implement advanced technologies, and deliver impactful research projects.'
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-white/90 mb-6 text-center max-w-3xl mx-auto">
            Graduates will pursue careers in Hotel Management, Event Planning, Tourism Policy, Destination Marketing, and Service Innovation. The global structure provides multi-campus exposure and cross-cultural fluency.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mt-8">
            {['Hotel Management', 'Event Planning', 'Tourism Policy', 'Destination Marketing', 'Service Innovation'].map((outcome, idx) => (
...
export default BBATourismCurriculumSection
